...
func (s *SoundGroup) GetSystemObject() (*System, error) {
	var system System
...
func (s *SoundGroup) GetMaxAudible() (int, error) {
...
func (s *SoundGroup) GetMaxAudibleBehavior(behavior *C.FMOD_SOUNDGROUP_BEHAVIOR) error {
...
func (s *SoundGroup) GetMuteFadeSpeed() (float64, error) {
	var speed C.float
...
func (s *SoundGroup) GetVolume() (float64, error) {
	var volume C.float
...
func (s *SoundGroup) GetUserData(userdata **interface{}) error {
